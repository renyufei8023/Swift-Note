...
var arr2:Array<Int> = [1,2,3]//这个只能放Int类型
var arr3 :[Int] = [1,2,3]
var arr4 = [1,"2","3"]
...
/*:
 元素类型
 OC:
 NSArray *arr = @[@1, @"ryf", @1.75];
 NSLog(@"%@", arr);
 */
var arr10 = [1,"ryf",1.75]
print(arr10)

// 如果想明确表示数组中存放的是不同类型的数据, 可以使用Any/AnyObject关键字, 表示数组中可以存放不同类型的数据

var arr11:Array<AnyObject> = [1,"ryf",1.75]
...
arr[0...1] = [99,01]
arr[0...1] = [99,88,77,66]
arr.replaceRange(1..<2, with: [99,111,222,333])
